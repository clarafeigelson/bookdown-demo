...
unpacked_data_1999 <- httr::content(raw_data_1999, as = "text", encoding = "UTF-8") 
final_data_1999 <- jsonlite::fromJSON(unpacked_data_1999)
...
final_data_2018 <- jsonlite::fromJSON(unpacked_data_2018)
...
```{r}
raw_data_2010_2021 <- httr::GET(url = "https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes=ROMO&startMonth=1&startYear=2010&endMonth=12&endYear=2021")
unpacked_data_2010_2021 <- httr::content(raw_data_2010_2021, as = "text", encoding = "UTF-8") 
final_data_2010_2021 <- jsonlite::fromJSON(unpacked_data_2010_2021)
...
```{r}
unit_visitation <- function(park, start_mo, start_year, end_mo, end_year){

# pull in the data
raw_data <- httr::GET(url = paste0("https://irmaservices.nps.gov/v3/rest/stats/visitation?unitCodes=", park, "&startMonth=", start_mo,"&startYear=", start_year, "&endMonth=", end_mo, "&endYear=", end_year))
...
```{r}
ROMO_visitation<-unit_visitation(park = "ROMO", start_year = 1990, start_mo = 1, end_year = 2021, end_mo = 12)
EVER_visitation<-unit_visitation(park = "EVER", start_year = 1990, start_mo = 1, end_year = 2021, end_mo = 12)
THRO_visitation<-unit_visitation(park = "THRO", start_year = 1990, start_mo = 1, end_year = 2021, end_mo = 12)
...
```{r}
unit_visitation <- function(park, start_mo = 1, start_year, end_mo = 12, end_year){
...
ROMO_visitation<-unit_visitation(park = "ROMO", start_year = 1990, end_year = 2021)
EVER_visitation<-unit_visitation(park = "EVER", start_year = 1990, end_year = 2021)
THRO_visitation<-unit_visitation(park = "THRO", start_year = 1990, end_year = 2021)
```
...
output_visitation <- vector("list", length = length(parks))
...
summary(output_visitation)

multi_parks <- dplyr::bind_rows(output_visitation)
...
map_visitation <- parks %>%
  map(~unit_visitation(.,start_year = 1980, end_year = 2021))

identical(output_visitation, map_visitation)

multi_parks2 <- bind_rows(map_visitation)
```
