...
To publish bookdown on a website:
1) Add, commit, push
2) Go to github, click settings, go to pages
3) Source = deploy from branch
4) Branch = main /docs
5) Click save
6) Go to Actions tab to see the progress of book creation
7) Go to bookdown-demo, scroll to Environments, and click View Deployment
